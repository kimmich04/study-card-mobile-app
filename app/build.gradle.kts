...
android {
    ...
    namespace = "com.example.annamstudyroomapp"
    ...
    defaultConfig {
        ...
        applicationId = "com.example.annamstudyroomapp"
...
//    implementation(libs.androidx.compose.foundation.layout)
    ...
    // Core Compose Material Icons (basic icons)
    implementation("androidx.compose.material:material-icons-core:1.7.8")

    // Extended Material Icons (includes all Material icons like ArrowBack)
